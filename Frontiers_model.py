...
for in_dim in [1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500]:
    ...
    for test_index in [0, 1, 2, 3, 4]:
        ...
        # 使用Keras Tuner的Hyperband算法进行超参数调优
        tuner = kt.Hyperband(
            build_model,
        ...
        # 对模型进行测试
        test_tuner(model, x_test, y_test, dirpath_project, dirpath_report, dirpath_matrix, title_auc, dirpath_auc,
                   str_param, test_index, val_index, class_names)
